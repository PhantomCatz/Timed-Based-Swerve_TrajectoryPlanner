...
public class CatzSwerveModule {
    ...
    {
        double velocity = Conversions.falconToMPS(DRIVE_MOTOR.getSelectedSensorVelocity(),CatzConstants.DRVTRAIN_WHEEL_CIRCUMFERENCE, CatzConstants.SDS_L2_GEAR_RATIO);
    ...
    {
        return DRIVE_MOTOR.getSelectedSensorPosition() / CatzConstants.SDS_L2_GEAR_RATIO * CatzConstants.DRVTRAIN_WHEEL_CIRCUMFERENCE / 2048.0;
    }
}